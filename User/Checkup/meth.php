...
?>
<form action="Methamphetamine" method="POST" id="form_upload" enctype="multipart/form-data">
...
<form action="export/export_Methamphetamine.php" method="POST" id="form_export" target="_blank">
    <div class="row">
...
<form action="Methamphetamine" id="formDelete" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['btnDelete'])){
    if(isset($_POST["id_delete"])){
        foreach($_POST['id_delete'] as $id){
            $result_delete = mysqli_query($conn,"call del_methamphetamine('$id')");
        }
        if(!$result_delete){
            echo"<script>";
            echo"window.location.href='Methamphetamine?delete2=fail';";
            echo"</script>";
        }
        else{
            echo"<script>";
            echo"window.location.href='Methamphetamine?delete=success';";
            echo"</script>";
        }
    }
    else{
        echo"<script>";
        echo"window.location.href='Methamphetamine?del=null';";
        echo"</script>";
    }
 }
...
function checkInputs_form_upload() {
    ...
    if (datepicker2Value !== "" && checkup_fileValue !== "") {
        ...
        document.getElementById("form_upload").action = "Methamphetamine";
