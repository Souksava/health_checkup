<!-- heavy_metal ການກວດວິເຄາະຫາທາດໂລຫະໜັກ(Metal)-->
<?php
  $title = "ການກວດວິເຄາະຫາທາດໂລຫະໜັກ";
  $path = "../../";
  $links = "../";
  $session_path = "../../";
    ...
    <div class="table-responsive">
        <table class="table-bordered" style="width: 8000px;text-align: center;">
            <tr style="font-size: 18px;">
                ...
                <th style="width: 87px;">Methy Hippuric acid in Urine</th>
                <th style="width: 50px;">Acetone in Urine</th>
                <th style="width: 87px;">Toluene in Urine</th>
                <th style="width: 50px;">Methyl lsobutyl Ketone in Urine</th>
