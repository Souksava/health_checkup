<!-- tumor_marker ການກວດກັ່ນຕອງມະເຮັງ(Tumor)-->
<?php
  $title = "ການກວດກັ່ນຕອງມະເຮັງ";
  $path = "../../";
  $links = "../";
  $session_path = "../../";
  include ("../../header-footer/header.php");
?>
<form action="Tumor" method="POST" id="form_upload" enctype="multipart/form-data">
...
<form action="export/export_tumor.php" method="POST" id="form_export" target="_blank">
    <div class="row">
...
<?php
 if(isset($_POST['btnDelete'])){
    ...
    if(isset($_POST["file_upload"])){
        $obj->import_tumor($_FILES["checkup_file"]["tmp_name"],$_POST["year"],$user_id);
    }
...
function checkInputs_form_upload() {
    ...
    if (datepicker2Value !== "" && checkup_fileValue !== "") {
        ...
        document.getElementById("form_upload").action = "Tumor";
